...
public class CalendarMonthView extends MonthView {
    ...
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme) {
        ...
        canvas.drawCircle(x + (float)mItemWidth / 2, y + (float)mItemHeight / 2, mRadio + mPadding, mSelectedPaint);
        return true;
    }
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        ...
        canvas.drawCircle(x + (float)mItemWidth / 2, y + (float)mItemHeight / 2, mRadio, mSchemeBasicPaint);
    }
